...
public class ChangePasswordActivity extends AppCompatActivity {
        ...
        changePassBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isValid()) {
                    ...
                    String user_id = (prefs.getString(AppConstant.Preference.USER_ID, "0"));
                    String physical_address = (prefs.getString(AppConstant.Preference.PHYSICAL_ADDRESS, "0"));
    ...
    private void changePassRequest(final String userId,final String oldPassword,final String newPassword,final String accessToken,final String physicalAddress, final ProgressDialog progressDialog) {
        StringRequest stringLoginRequest = new StringRequest(Request.Method.POST, AppConstant.API.CHANGE_PASSWORD,
    ...
    public void onChangeSuccess(String message,String newPassword,String accessToken) {
        ...
        editor.putString(AppConstant.Preference.PASSWORD, newPassword);
