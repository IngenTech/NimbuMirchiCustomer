...
//        if (convertView == null) {
        ...
        if (convertView == null)
            vi = inflater.inflate(R.layout.customer_pending_order_card, null);
        ...
        if (data.size() > 0) {
            ...
            holder.txtContent3.setText(tempValues.getTripDate());
            ...
            holder.row_item.setOnClickListener(new CustomerPendingOrderAdapter.OnItemClickListener(position));
    ...
    private void cancelOrder(final CustomerPendingOrder customerPendingOrder) {
        ...
        StringRequest stringVarietyRequest = new StringRequest(Request.Method.POST, AppConstant.API.CANCEL_ORDER_API,
