...
public class RoadPermitAdapter  extends RecyclerView.Adapter<RoadPermitAdapter.ViewHolder> {
    ...
    private void roadPermitDownload(final String roadPermitID, final ViewHolder holder,final int pos) {
        StringRequest viewDocRequest = new StringRequest(Request.Method.POST, AppConstant.API.DOWNLOAD_ROADTRIP_IMAGE,
...
//                                        holder.rowImage.setImageBitmap(decodedByte);
                                        ...
                                        poss =pos;
                                        Glide.with(mContext).load(imageString).centerCrop().into(holder.rowImage);
        ...
        public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    String name = "customer_roadpermit_"+mDataset.get(poss).getPermitID()+ ".jpg";
