...
import com.iembsys.admin.nimbumirchi.customer.bean.InfoWindowAdapter;
import com.iembsys.admin.nimbumirchi.customer.bean.KeyValueData;
import com.iembsys.admin.nimbumirchi.customer.bean.TrackData;
import com.iembsys.admin.nimbumirchi.customer.bean.VehicleData;
...
public class TrackMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void trackMethod(final String accountId, final String orderId, final String accessToken) {
        ...
        StringRequest stringVarietyRequest = new StringRequest(Request.Method.POST, AppConstant.API.TRACK_API,
