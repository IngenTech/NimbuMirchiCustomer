...
import com.iembsys.admin.nimbumirchi.customer.bean.LiveData;
...
public class LiveMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void getLiveLocation() {
        ...
        StringRequest stringVarietyRequest = new StringRequest(Request.Method.POST, AppConstant.API.LIVE_API,
