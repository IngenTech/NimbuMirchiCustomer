...
import com.iembsys.admin.nimbumirchi.customer.util.LocalReportSender;
...
public class NimbuMirchiApplication extends Application {

    public static final String TAG = NimbuMirchiApplication.class.getSimpleName();

    private RequestQueue mRequestQueue;

    private static NimbuMirchiApplication mInstance;
    ...
    public static synchronized NimbuMirchiApplication getInstance() {
        return mInstance;
    }
