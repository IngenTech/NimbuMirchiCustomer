...
//         inflater.inflate(R.layout.fragment_customer_trip_history, container, false);
        ...
        searchHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (from_date == null || from_date.length() < 7) {
                    ...
                    Toast.makeText(getActivity(), "Please select last date", Toast.LENGTH_SHORT).show();
                } else {
                    loadHistoryList();
                }
            }
    ...
    private void loadHistoryList() {
        ...
        StringRequest stringVarietyRequest = new StringRequest(Request.Method.POST, AppConstant.API.TRIP_HISTORY_LIST_API,
                        ...
                        try {
                            ...
                            if (jsonObject.has("Status") && (jsonObject.getString("Status").equalsIgnoreCase("1"))) {
                                if (jsonObject.get("Result").equals("Success")) {
                                    ...
                                    customerRunningTripDatas = new ArrayList<>();
        ...
        dialog = ProgressDialog.show(getActivity(), "Trip History", "Please wait.....", true);
