...
import com.iembsys.admin.nimbumirchi.customer.adapter.DistanceReportAdapter;
...
public class DistanceReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imei = (TextView)findViewById(R.id.distance_imei);
        vehicalName = (TextView)findViewById(R.id.distance_vehicalName);
    ...
    private void distanceReport() {
        StringRequest stringLoginRequest = new StringRequest(Request.Method.POST, AppConstant.API.DISTANCE_REPORT,
                        ...
                        try {
                            ...
                            if (jsonObject.has("Status") && (jsonObject.getString("Status").equalsIgnoreCase("1"))) {
                                if (jsonObject.getString("Result").equals("Success")) {
                                    ...
                                    imei.setText(jsonObject.getString("IMEI"));
                                    vehicalName.setText(jsonObject.getString("VehicleNo"));
                                    ...
                                    for (int d=0; d<jsonArray.length(); d++){
                                        ...
                                        distanceData.setDateFrom(jsonObject1.getString("Traveldate"));
                                     //  distanceData.setDateTo(jsonObject1.getString("DateTo"));
                                        distanceData.setDistance(jsonObject1.getString("DistanceTravelled"));
