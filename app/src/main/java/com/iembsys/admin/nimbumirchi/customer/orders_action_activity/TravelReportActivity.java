...
import com.iembsys.admin.nimbumirchi.customer.adapter.TravelListAdapter;
import com.iembsys.admin.nimbumirchi.customer.bean.TravelData;
...
public class TravelReportActivity extends AppCompatActivity {
   ...
   private String order_id;
    ...
    private void getVehiclesTravelReport(final String accountId, final String orderId, final String accessToken) {
        ...
        StringRequest stringVarietyRequest = new StringRequest(Request.Method.POST, AppConstant.API.TRAVEL_REPORT_API,
