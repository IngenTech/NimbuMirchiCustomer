...
public class CustomerConfirmOrderAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.action3 = (TextView) vi
                    .findViewById(R.id.action3Button);
        ...
        if (data.size() <= 0) {
            ...
            holder.txtContent0.setText("Order Date: "+tempValues.getOrderDate());
            ...
            holder.txtRightContent1.setText(tempValues.getIMEI());
    ...
    private class OnItemClickListener implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            if (customerConfirmOrder != null) {
                ...
                if (arg0.getId() == R.id.action3Button) {
                    ArrayList<ContentData> contentDatas = customerConfirmOrder.getContentData();
    ...
    private void cancelOrder(final CustomerConfirmOrder customerConfirmOrder) {
        ...
        StringRequest stringVarietyRequest = new StringRequest(Request.Method.POST, AppConstant.API.CANCEL_ORDER_API,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String accountId = prefs.getString(AppConstant.Preference.ACCOUNT_ID, "");

                Map<String, String> map = new HashMap<>();
                map.put("api_key", BuildConfig.API_KEY);
                map.put("app_type", BuildConfig.APP_TYPE);
                map.put("order_id", customerConfirmOrder.getDocketNo());
