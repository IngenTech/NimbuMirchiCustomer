...
public class InvoiceAdapter  extends RecyclerView.Adapter<InvoiceAdapter.ViewHolder> {
  ...
  */
       ...
       // holder.setIsRecyclable(false);
        ...
        holder.invoiceImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                viewInviceList(invoiceID,holder,position);
    ...
    private void viewInviceList(final String invoiceID, final ViewHolder holder,final int pos) {
        StringRequest viewDocRequest = new StringRequest(Request.Method.POST, AppConstant.API.DOWNLOAD_INVOICE_IMAGE,
                                ...
                                if (jsonObject.get("Result").equals("Success")) {
                                    ...
                                    if (imageString!=null) {
                                       /* byte[] decodedString = Base64.decode(imageString, Base64.DEFAULT);
                                        ...
                                        Glide.with(mContext).load(imageString).centerCrop().into(holder.invoiceImage);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if (prefs == null) {
                    prefs = mContext.getSharedPreferences(AppConstant.Preference.APP_PREFERENCE, mContext.MODE_PRIVATE);
                }
        ...
        public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    String name = "customer_invoice_"+mDataset.get(poss).getInvoiceID()+ ".jpg";
